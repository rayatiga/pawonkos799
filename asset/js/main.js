    ...
    footerBottom.innerHTML = `
            <div class="container py-4">
                <div class="row row-cols-1 row-cols-lg-3 g-4">
                    <div class="col"><img src="/asset/image/nav-logo.png" alt="Pawonkos799" width="50" /><span class="d-block fw-semibold fs-4">Pawonkos799</span><span class="d-block">Produk Pawonkos ini sangat mengedepankan cita rasa Nusantara. Semua Produk kami adalah produk handmade by order dan bergaransi!</span></div>
